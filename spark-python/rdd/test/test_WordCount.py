...
def word_count():
    ...
    for name in names:
        ...
        """        
        # Write-Overwrites
        file_palindrome_path = "out/spark-palindrome/" + str(folder_count) + "_" + name + ".txt"
        file_palindrome = open(file_palindrome_path,"w")#write mode 
        ...
        file_anagram_path = "out/spark-anagram/" + str(folder_count) + "_" + name + ".txt"
        file_anagarm = open(file_anagram_path,"w")#write mode 
